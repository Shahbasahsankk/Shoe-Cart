            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ShoeCircleAvatarWidget(
                      ...
                      text: 'Sneakers',
                      ontap: () =>
                          homeProvider.toCollectionScreen(context, 'Sneakers'),
                    ),
                    ...
                    ShoeCircleAvatarWidget(
                      ...
                      text: 'Sports',
                      ontap: () =>
                          homeProvider.toCollectionScreen(context, 'Sports'),
                    ),
                    AppSizedBoxes.sizedboxW10,
                    ShoeCircleAvatarWidget(
                      ...
                      text: 'Formals',
                      ontap: () =>
                          homeProvider.toCollectionScreen(context, 'Formals'),
                    ),
                    AppSizedBoxes.sizedboxW10,
                    ShoeCircleAvatarWidget(
                      ...
                      text: 'Boots',
                      ontap: () =>
                          homeProvider.toCollectionScreen(context, 'Boots'),
                    ),
                    AppSizedBoxes.sizedboxW10,
                    ShoeCircleAvatarWidget(
                      ...
                      text: 'Loafers',
                      ontap: () =>
                          homeProvider.toCollectionScreen(context, 'Loafers'),
                    ),
                  ],
                ),
                ...
                Row(
                  ...
                  children: [
                    SalesWidget(
                      imagePath: 'assets/home_page_assets/kidsshoes_sales.jpeg',
                      text1: 'Kids Shoes',
                      text2: '50% SALE',
                    ...
                    SalesWidget(
                      imagePath: 'assets/home_page_assets/menshoes_sales.jpeg',
                      text1: 'Men Sneakers',
                      text2: 'From ₹1300',
                      ontap: () => homeProvider.toCollectionScreen(
                ...
                CustomContainerWidget(
                  ...
                  imagePathOne: 'assets/home_page_assets/sneakers_minimum.jpeg',
                  imagePathTwo: 'assets/home_page_assets/women_sports_off.jpeg',
                  imagePathThree:
                      'assets/home_page_assets/women_boots_off.jpeg',
                  imagePathFour: 'assets/home_page_assets/kids_shoes_off.jpeg',
                  containerColor: Colors.teal[100]!,
                  ontap: () =>
                      homeProvider.toCollectionScreen(context, 'All offers'),
                  ontap2: () =>
                      homeProvider.toCollectionScreen(context, 'Men Sneakers'),
                  ontap3: () =>
                      homeProvider.toCollectionScreen(context, 'Women Sports'),
                  ontap4: () =>
                      homeProvider.toCollectionScreen(context, 'women Boots'),
                  ontap5: () =>
                      homeProvider.toCollectionScreen(context, 'Kids Wears'),
                ),
                AppSizedBoxes.sizedboxH15,
                const CustomBorderProductViewContainer(
                  productName1: 'STELVIO Lace-Up Ankle-Length Combat Boots',
                  productName2: 'GULASS WICK Mocassins Casual Loafers for Men',
                  productName3:
                      'GO21 Mid-Top Colourblock Lace-Up Sneakers For Men',
                  imagePath1: 'assets/home_page_assets/men_boots1.jpeg',
                  imagePath2: 'assets/home_page_assets/men_loafer2.jpeg',
                  imagePath3: 'assets/home_page_assets/men_sneaker1.jpeg',
                ...
                CustomContainerWidget(
                  ...
                  offerFour: 'From 499',
                  imagePathOne: 'assets/home_page_assets/mens_sports_off1.jpeg',
                  imagePathTwo:
                      'assets/home_page_assets/women_sneakers_off1.jpeg',
                  imagePathThree: 'assets/home_page_assets/men_loafer1.jpeg',
                  imagePathFour: 'assets/home_page_assets/kids_shoes_off2.jpeg',
                  containerColor: AppColors.whiteColor70,
                  ontap: () =>
                      homeProvider.toCollectionScreen(context, 'All offers'),
                  ontap2: () =>
                      homeProvider.toCollectionScreen(context, 'Men Sports'),
                  ontap3: () => homeProvider.toCollectionScreen(
                      context, 'Women Sneakers'),
                  ontap4: () =>
                      homeProvider.toCollectionScreen(context, 'Men Loafers'),
                  ontap5: () =>
                      homeProvider.toCollectionScreen(context, 'Kids Wears'),
                ),
                AppSizedBoxes.sizedboxH15,
                const CustomBorderProductViewContainer(
                  ...
                  imagePath1: 'assets/home_page_assets/women_formals1.jpeg',
                  imagePath2: 'assets/home_page_assets/kids_sports.jpeg',
                  imagePath3: 'assets/home_page_assets/women_boots1.jpeg',
                ...
                CustomContainerWidget(
                  ...
                  imagePathOne: 'assets/home_page_assets/men_formals_off1.jpeg',
                  imagePathTwo:
                      'assets/home_page_assets/women_loafers_off1.jpeg',
                  imagePathThree: 'assets/home_page_assets/men_boots_off1.jpeg',
                  imagePathFour:
                  ...
                  ontap: () =>
                      homeProvider.toCollectionScreen(context, 'All offers'),
                  ontap2: () =>
                      homeProvider.toCollectionScreen(context, 'Men Formals'),
                  ontap3: () =>
                      homeProvider.toCollectionScreen(context, 'women Loafers'),
                  ontap4: () =>
                      homeProvider.toCollectionScreen(context, 'Men Boots'),
                  ontap5: () =>
                      homeProvider.toCollectionScreen(context, 'Women Formals'),
                ),
              ],
            ),
          ),
