...
import 'package:e_commerce_app/view/onBoard/util/onboard_model_list.dart';
import 'package:e_commerce_app/widgets/custom_button1.dart';
import 'package:e_commerce_app/widgets/custom_indicator.dart';
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        index == 2
                            ? const SizedBox()
                            : TextButton(
                                onPressed: ()=>onBoardProvider.toSignInScreen(context),
                                child: const Text('Skip',style: AppTextStyles.textStyle3,),
                              ),
                        Padding(
